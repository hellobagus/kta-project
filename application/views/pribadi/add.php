                ...
                <div class="card">
                  <div class="card-header">
                    <div class="card-header-action">
                      <a href="<?php echo base_url('DataDiri')?>" class="btn btn-primary">
                  ...
                  <div class="card-body">
                    <form id="frm" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-9">
                          <input type="text" name="j_anak" id="j_anak" class="form-control" onkeypress="return check_int(event)" maxlength="2">
                          <small class="text-danger">input hanya angka</small>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-9">
                          <select name="pekerjaan" id="pekerjaan" class="form-control">
                            <option value="">Pilih Pekerjan</option>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    ...
    function  loaddata()
    {
      $.getJSON("<?php echo base_url('DataDiri/getNama')?>", function(data)
      {
        console.log(data);
        var kd = data.header[0].kode_wilayah;
        if (kd == "0901")
        {
          $hasil = 'Jakarta Pusat';
        }
        ...
        else if (kd == "0905")
        {
          ...
          $hasil = 'Kepulauan Seribu';
        }
        $('#kode_wilayah_text').val($hasil);

        $('#kode_wilayah').val(data.header[0].kode_wilayah);
        ...
        $no_wa = data.header[0].no_wa;
        var format = $no_wa.substr(2, $no_wa.length);
        $('#no_wa').val(format);
    ...
    $('#savefrm').click(function(event)
    {
      ...
      if (event.handled !== true) {
        ...
        if ($('#frm').valid())
        {
          ...
          $.ajax({
            url : "<?php echo base_url('DataDiri/save')?>",
            type:"POST",
            data: datafrm,
            dataType:"json",
              ...
              if (event.Error == false)
              {
                Swal.fire({
                  ...
                  confirmButtonText: "OK"
                    ...
                    window.location.href = "<?php echo base_url('DataDiri')?>";
                  });
              } else {
                Swal.fire({
                  title: "Information",
